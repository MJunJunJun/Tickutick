...
import com.example.pertemuan7.databinding.ActivityInputData4Binding
...
class InputDataActivity4 : AppCompatActivity() {

    private lateinit var binding: ActivityInputData4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityInputData4Binding.inflate(layoutInflater)
        setContentView(binding.root)

        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        // Data tempat wisata untuk spinner
        val dataWisata = listOf("Mas Kemambang")
