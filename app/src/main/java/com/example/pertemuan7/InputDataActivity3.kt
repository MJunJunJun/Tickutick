...
import com.example.pertemuan7.databinding.ActivityInputData3Binding
...
class InputDataActivity3 : AppCompatActivity() {

    private lateinit var binding: ActivityInputData3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityInputData3Binding.inflate(layoutInflater)
        setContentView(binding.root)

        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        // Data tempat wisata untuk spinner
        val dataWisata = listOf("Menara Teratai")
